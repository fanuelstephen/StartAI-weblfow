    ...
    return (
        <div className="section">
            <div className="minimize_content">
                ...
                <div>
                    <ul>
                        <li> <IoCheckmarkCircleSharp  className="markIcon"/>{MinimizeData[0].desc1}</li>
                        <li> <IoCheckmarkCircleSharp  className="markIcon"/>{MinimizeData[0].desc2}</li>
                        <li> <IoCheckmarkCircleSharp className="markIcon" />{MinimizeData[0].desc3}</li>
